...
// 🟢 FIXED PATHS: Since this file is in lib/, we look directly into the bloc/ subfolder
          ...
          child: BlocConsumer<MpinBloc, MpinState>(
            listener: (context, state) {
              if (state is LoginMpinSuccess) {
                ...
                // Clear fields and restore base focus position cleanly
                            ...
                            Row(
                              ...
                              children: List.generate(4, (index) {
                                return SizedBox(
                                  ...
                                  // 🟢 FIX: Removed the conflicting parent FocusNode assignment from KeyboardListener
                                ...
                                onPressed: isLoading
                                    ...
                                    : () {
                                        String pin = _controllers
                                            ...
                                            .join();
                                        if (pin.length == 4) {
                                          // 🟢 FIX: Uses the proper context provided by the active Builder scope
                                          BlocProvider.of<MpinBloc>(context).add(LoginMpinSubmitted(pin));
                                        } else {
